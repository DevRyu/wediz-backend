...
from .views import MainInformation, MainAgreement, FundMakerView, FundPolicyView, FundProjectView, StoryMainImage, FundStoryView, RewardView,FundDetailView
...
urlpatterns = [
    ...
    path('/<int:fund_id>', FundDetailView.as_view())
]
